...
class Round(BaseModel):
    ...
    contact_us_banner_json = Column(
        "contact_us_banner_json", JSON(none_as_null=True), nullable=True, unique=False
    )
    ...
    instructions_json = Column(
        "instructions_json", JSON(none_as_null=True), nullable=True, unique=False
    )
    ...
    eoi_decision_schema = Column(
        "eoi_decision_schema ", JSON(none_as_null=True), nullable=True, unique=False
    )
