...
from _helpers.application import (
    get_application_eoi_response,
    send_submit_notification,
    send_submitted_application_to_assess,
)
...
class ApplicationsView(MethodView):
    ...
    def submit(self, application_id):
        ...
        try:
            ...
            send_submitted_application_to_assess(application_with_form_json)

            if round_data.is_expression_of_interest:
                eoi_results = get_application_eoi_response(application_with_form_json)
