...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            True,
            "en",
            "apply/all_questions/uses_translations/cof_r2_all_questions.html",
        ),
        (
            "cof",
            "r2w2",
        ...
        (
            ...
            True,
            "cy",
            "apply/all_questions/cy/cof_r5w1_all_questions_cy.html",
        ),
        (
            "abc",
            "xyz",
            True,
            "en",
            "apply/all_questions/en/abc_xyz_all_questions_en.html",
        ),
        (
            "abc",
            "xyz",
            True,
            "cy",
            "apply/all_questions/cy/abc_xyz_all_questions_cy.html",
        ),
        (
            "abc",
            "xyz",
