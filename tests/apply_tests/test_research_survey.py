...
@patch("pre_award.apply.default.application_routes.get_application_data")
@patch("pre_award.apply.default.application_routes.get_round_data")
@patch("pre_award.apply.default.application_routes.get_research_survey_from_store")
@patch("pre_award.apply.default.application_routes.determine_round_status", lambda x: MagicMock(is_open=True))
...
@patch("pre_award.apply.default.application_routes.get_round_data")
@patch("pre_award.apply.default.application_routes.get_research_survey_from_store")
@patch("pre_award.apply.default.application_routes.post_research_survey_to_store")
@patch("pre_award.apply.default.application_routes.determine_round_status", lambda x: MagicMock(is_open=True))
